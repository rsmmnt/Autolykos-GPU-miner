...
#pragma unroll
    ...
    asm volatile ("sub.cc.u32 %0, %0, 0xD0364141;": "+r"(h[0]));
    asm volatile ("subc.cc.u32 %0, %0, 0xBFD25E8C;": "+r"(h[1]));
    asm volatile ("subc.cc.u32 %0, %0, 0xAF48A03B;": "+r"(h[2]));
    asm volatile ("subc.cc.u32 %0, %0, 0xBAAEDCE6;": "+r"(h[3]));
...
#pragma unroll
    ...
    //====================================================================//
    asm volatile ("mad.lo.cc.u32 %0, %1, 0xD0364141, %0;": "+r"(h[0]): "r"(carry));
    asm volatile ("madc.lo.cc.u32 %0, %1, 0xBFD25E8C, %0;": "+r"(h[1]): "r"(carry));
    asm volatile ("madc.lo.cc.u32 %0, %1, 0xAF48A03B, %0;": "+r"(h[2]): "r"(carry));
    asm volatile ("madc.lo.cc.u32 %0, %1, 0xBAAEDCE6, %0;": "+r"(h[3]): "r"(carry));
    asm volatile ("madc.lo.cc.u32 %0, %1, 0xFFFFFFFE, %0;": "+r"(h[4]): "r"(carry));
...
#pragma unroll
    ...
    asm volatile ("madc.lo.u32 %0, %1, 0xFFFFFFFF, %0;": "+r"(h[7]): "r"(carry));
...
#pragma unroll
    ...
    //  med[0, ..., 5] = d * Q
    //====================================================================//
        asm volatile ("mul.lo.u32 %0, %1, 0xD0364141;": "=r"(med[0]): "r"(d[0]));
        asm volatile ("mul.hi.u32 %0, %1, 0xD0364141;": "=r"(med[1]): "r"(d[0]));
        asm volatile ("mul.lo.u32 %0, %1, 0xAF48A03B;": "=r"(med[2]): "r"(d[0]));
        asm volatile ("mul.hi.u32 %0, %1, 0xAF48A03B;": "=r"(med[3]): "r"(d[0]));

        asm volatile (
            "mad.lo.cc.u32 %0, %1, 0xBFD25E8C, %0;": "+r"(med[1]): "r"(d[0])
        );

        asm volatile (
            "madc.hi.cc.u32 %0, %1, 0xBFD25E8C, %0;": "+r"(med[2]): "r"(d[0])
        );

        asm volatile (
            "madc.lo.cc.u32 %0, %1, 0xBAAEDCE6, %0;": "+r"(med[3]): "r"(d[0])
        );

        asm volatile (
            "madc.hi.u32 %0, %1, 0xBAAEDCE6, 0;": "=r"(med[4]): "r"(d[0])
        );

    //====================================================================//
        asm volatile (
            "mad.lo.cc.u32 %0, %1, 0xD0364141, %0;": "+r"(med[1]): "r"(d[1])
        );

        asm volatile (
            "madc.hi.cc.u32 %0, %1, 0xD0364141, %0;": "+r"(med[2]): "r"(d[1])
        );

        asm volatile (
            "madc.lo.cc.u32 %0, %1, 0xAF48A03B, %0;": "+r"(med[3]): "r"(d[1])
        );
        ...
        asm volatile (
            "mad.lo.cc.u32 %0, %1, 0xBFD25E8C, %0;": "+r"(med[2]): "r"(d[1])
        );

        asm volatile (
            "madc.hi.cc.u32 %0, %1, 0xBFD25E8C, %0;": "+r"(med[3]): "r"(d[1])
        );

        asm volatile (
            "madc.lo.cc.u32 %0, %1, 0xBAAEDCE6, %0;": "+r"(med[4]): "r"(d[1])
        );

        asm volatile (
            "madc.hi.u32 %0, %1, 0xBAAEDCE6, %0;": "+r"(med[5]): "r"(d[1])
        );
...
#pragma unroll
    ...
    //====================================================================//
    asm volatile ("mad.lo.cc.u32 %0, %1, 0xD0364141, %0;": "+r"(r[0]): "r"(carry));
    asm volatile ("madc.lo.cc.u32 %0, %1, 0xBFD25E8C, %0;": "+r"(r[1]): "r"(carry));
    asm volatile ("madc.lo.cc.u32 %0, %1, 0xAF48A03B, %0;": "+r"(r[2]): "r"(carry));
    asm volatile ("madc.lo.cc.u32 %0, %1, 0xBAAEDCE6, %0;": "+r"(r[3]): "r"(carry));
    asm volatile ("madc.lo.cc.u32 %0, %1, 0xFFFFFFFE, %0;": "+r"(r[4]): "r"(carry));
...
#pragma unroll
    ...
    asm volatile ("madc.lo.u32 %0, %1, 0xFFFFFFFF, %0;": "+r"(r[7]): "r"(carry));
