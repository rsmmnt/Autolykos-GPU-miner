...
nvcc -o ../miner.exe -gencode arch=compute_%CUDA_COMPUTE_ARCH%,code=sm_%CUDA_COMPUTE_ARCH%^
 -gencode arch=compute_30,code=compute_30 -DBLOCK_DIM=%BLOCK_DIM% -DCOMM_WEBSOCKET ^
...
mining.cu prehash.cu processing.cc reduction.cu request.cc easylogging++.cc websocket.cc easywsclient.cc
cd ..